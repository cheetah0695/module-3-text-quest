...
public class QuestStep {
    ...
    public QuestStep(String id, String text, String option1, String option2, String nextStepId1, String nextStepId2, String image) {
        this.id = id;
        this.text = text;
    ...
    public String getNextStep(String answer) {
        boolean firstAnswerSelected = answer.equals(this.option1);
        int faultyAnswerId = this.nextStepId1.contains("lose") ? 1 : 2;

        if ((firstAnswerSelected && faultyAnswerId == 1) || (!firstAnswerSelected && faultyAnswerId == 2)) {
            return faultyAnswerId == 1 ? this.nextStepId1 : this.nextStepId2;
        } else {
            return faultyAnswerId == 1 ? this.nextStepId2 : this.nextStepId1;
        }
    }
